...
export const defaultOpts: MEditor.IStandaloneEditorConstructionOptions = {
	...
	fontFamily:
		'Menlo-Regular, Monaco, Menlo, Consolas, "Ubuntu Mono", monospace',
	formatOnPaste: true,
	formatOnType: true,
	insertSpaces: true,
...
export const registerDatavDarkTheme = (monaco: Monaco) => {
	const themeName = 'react-echarts-json-dark-theme'
...
export const handleInputCode = (
	languageId: languageType,
	code: string | any[] | object
) => {
	let val = code
